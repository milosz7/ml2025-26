...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        "--lora_unet_modules",
        type=str,
        default=",".join(UNET_TARGET_MODULES),
        help="comma delimited list of modules to use for lora layers. (unet)")

    parser.add_argument(
        "--lora_text_encoder_modules",
        type=str,
        default=",".join(TEXT_ENCODER_TARGET_MODULES),
        help="comma delimited list of modules to use for lora layers (text encoder).")
...
def main(args):
    ...
    if args.use_lora:
        config = LoraConfig(
            ...
            target_modules=args.lora_unet_modules.split(","),
    ...
    if not args.train_text_encoder:
        ...
        config = LoraConfig(
            ...
            target_modules=args.lora_text_encoder_modules.split(","),
